...
import '../../features/documents/data/datasources/document_templates_db.dart';
...
Future<void> initDependencies() async {
  ...
  sl.registerLazySingleton<GroqClient>(() => GroqClient(sl<Dio>()));

  sl.registerLazySingleton<GeminiClient>(
    () => GeminiClient(sl<Dio>(), fallback: sl<GroqClient>()),
  );
  ...
  sl.registerLazySingleton<EmailService>(() => EmailService(sl<Dio>()));
  ...
  sl.registerLazySingleton<DocumentTemplatesDb>(DocumentTemplatesDb.new);
  sl.registerLazySingleton<DocumentsRepository>(
    () => DocumentsRepositoryImpl(
      sl<DocumentTemplatesDb>(),
  ...
  sl.registerLazySingleton<GeminiRecommendationsDataSource>(
    () => GeminiRecommendationsDataSourceImpl(sl<GeminiClient>()),
  );
  ...
  sl.registerLazySingleton<GeminiInsightsDataSource>(
    () => GeminiInsightsDataSourceImpl(sl<GeminiClient>()),
  );
  ...
  sl.registerLazySingleton<GeminiContractAnalyzer>(
    () => GeminiContractAnalyzer(sl<GeminiClient>()),
  );
  ...
  sl.registerLazySingleton<DocumentTranslator>(
    () => DocumentTranslator(sl<GeminiClient>()),
  );
